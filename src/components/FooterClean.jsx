...
const FooterClean = () => {
  ...
  <div className="flex justify-between pt-12 flex-col lg:flex-row">
    <div>
      <p className="lexend-font font-bold">© 2024 Randolympics. All rights reserved.</p>
    </div> 

    <div className="flex flex-col lg:flex-row gap-4 text-[#d24949] lexend-font font-bold">
      <p>Privacy policy</p>
