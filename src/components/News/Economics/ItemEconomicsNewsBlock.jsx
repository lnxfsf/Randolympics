  ...
  return (
    <>
      {gamesPosts && gamesPosts[number] && (
        <div
          className="flex w-[90%] sm:w-[70%] mt-4 h-64 bg-body_news p-4 rounded-lg gap-8 blog-container cursor-pointer"
          onClick={() => {
            navigate(
              `/news/economics/${gamesPosts[number].postId}/${gamesPosts[number].title}`
            );
          }}
        >
          ...
          <div className="basis-1/2 flex flex-col ">
            ...
            <div className="grow mt-2">
              <p className="two-line-limit text-xl font-semibold mb-2">
                {gamesPosts[number].title || ""}
              </p>

              <p className="three-line-limit text-base text-text_news font-medium ">
            ...
            <div className="flex items-center justify-between ">
              ...
              <p className="text-red_first text-sm font-semibold cursor-pointer select-none">
                Read More
              </p>
            </div>
          </div>
