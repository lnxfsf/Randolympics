    ...
    return (
        <>
            ...
            {(gamesPosts && gamesPosts[number]) && (
                ...
                onClick={() => { navigate(`/news/news/${gamesPosts[number].postId}/${gamesPosts[number].title}`); }}
                ...
                >
                    ...
                    <div className="grow">
                        <p className="three-line-limit text-sm font-bold mb-2 ">{gamesPosts[number].title || ""}</p>



                        <p className="two-line-limit text-sm fond-semibold text-[#716363] ">{gamesPosts[number].subtitle || ""}</p>
