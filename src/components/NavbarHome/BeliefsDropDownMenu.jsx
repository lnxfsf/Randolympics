        ...
        <div className="grid  grid-rows-4 grid-cols-2  min-h-64  mt-2 ">
          <div className=" mt-1 ">
            ...
            <p className="pt-2 pb-2">
              ...
              nationality, race, values, religion, political views, gender,
          ...
          <div className=" mt-1 ">
            <hr />
            <p className="pt-2 pb-2">
              Transparency is our commitment, using open-source technology for
          ...
          <div className=" mt-1 ">
            <p className="pt-2 pb-2">
              ...
              cities will ensure everyone can join, arranging necessary visas
          ...
          <div className=" mt-1 ">
            <p className="pt-2 pb-2">
              We may not always have luxury, sometimes staying in tents or using
              old equipment, but we will never compromise on our core values.
            </p>
          ...
          <div className=" mt-1 ">
            <p className="pt-2 pb-2">
              We stand against any political pressure to exclude athletes based
