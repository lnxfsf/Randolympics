  ...
  return (
    <>
      ...
      <div className="flex justify-center w-full ">
        ...
        <div className="flex  w-[95%] lg:w-[80%]  min-[1536px]:w-[65%] max-[2000px]:w-[65%]  min-[2001px]:w-[52%] lexend-font text-black_second ">
          ...
          <div className="hidden min-[890px]:flex basis-1/2 flex-col justify-start gap-4  m-16 grow">
